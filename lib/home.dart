    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // Banner at the top of the detail page
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 16.0, vertical: 8.0),
              child: ClipRRect(
                borderRadius: BorderRadius.circular(16.0),
                child: Image.asset(
                  'images/market.png', // Replace with actual asset path
                  width: double.infinity,
                  height: 250.0,
                  fit: BoxFit.cover,
                ),
            ...
            ElevatedButton(
              onPressed: () {
                final items = groceryListController.text.split('\n').where((item) => item.trim().isNotEmpty).toList();
                if (items.isNotEmpty) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Please enter grocery items.')));
                }
              },
              style: ElevatedButton.styleFrom(
